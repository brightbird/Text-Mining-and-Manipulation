...
Ques <- read.xlsx2("Y:/PH.D/PSU/Part-time job/MOOC/Attempts/submitters_CS_new1.xls", 1)
head(Ques)
...
#######################################################
## save file ##
write.xlsx2(x = combined, file = "Y:/PH.D/PSU/Part-time job/MOOC/Attempts/1278_revised.xlsx",sheetName = "submitter", row.names = FALSE)
